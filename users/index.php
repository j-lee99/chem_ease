...
require_once '../partial/db_conn.php';   // ← add this
...
// Use DB values (these override anything stale in session)
$full_name     = $user['full_name'];
$profile_image = $user['profile_image'] ?? '';

// Optional: update session so other pages benefit immediately
